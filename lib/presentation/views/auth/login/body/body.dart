...
class _LoginViewBodyState extends State<LoginViewBody> {
  ...
  void _loginUser() async {
    ...
    final result = await AuthService().loginUser(user);
    ...
    if (result == null) {
      ...
      final result2 = await SharedPrefsHelper()
          .saveToken(token);
      ...
      if (result2 == 'success') {
        ...
        floatingSnackBar(message: "Logged in successfully.", context: context);
      } else {
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            ...
            NavigationHelper.pushScreen(context, const RegisterView());
          },
          child: const Text(
            "Register",
            style: TextStyle(
